...
import vook.server.api.app.context.demo.domain.DemoTermRepository;
import vook.server.api.app.context.demo.domain.DemoTermSynonymRepository;
import vook.server.api.app.context.user.domain.SocialUserRepository;
import vook.server.api.app.context.user.domain.UserInfoRepository;
import vook.server.api.app.context.user.domain.UserRepository;
