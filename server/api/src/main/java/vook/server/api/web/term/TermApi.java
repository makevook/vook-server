...
public interface TermApi {
    ...
    @IncludeOkResponse(implementation = TermApiCreateResponse.class)
    ...
    @IncludeOkResponse(implementation = TermApiRetrieveResponse.class)
    ...
    @IncludeOkResponse(implementation = TermApiSearchResponse.class)
    @IncludeBadRequestResponse({INVALID_PARAMETER, VIOLATION_BUSINESS_RULE})
